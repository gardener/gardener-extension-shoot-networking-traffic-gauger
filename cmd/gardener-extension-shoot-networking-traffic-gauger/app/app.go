...
func NewServiceControllerCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:           "gardener-extension-shoot-networking-traffic-gauger",
		Short:         "Networking traffic gauger controller manages components which provide the network traffic gauger agents.",
		SilenceErrors: true,
...
func (o *Options) run(ctx context.Context) error {
	...
	ctrlConfig := o.ntgOptions.Completed()

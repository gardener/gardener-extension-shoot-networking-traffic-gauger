...
import (
	...
	_ "github.com/gardener/gardener-extension-shoot-networking-traffic-gauger/test/integration/healthcheck"
)
...
func TestGardenerSuite(t *testing.T) {
	RunSpecs(t, "shoot-networking-traffic-gauger Test Suite")
}

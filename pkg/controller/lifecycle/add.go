...
const (
	...
	Name = "shoot_networking_traffic_gauger_lifecycle_controller"
	// FinalizerSuffix is the finalizer suffix for the network traffic gauger controller.
	FinalizerSuffix = constants.ExtensionType
)

// DefaultAddOptions contains configuration for the network traffic gauger.
...
type AddOptions struct {
	...
	// ServiceConfig contains configuration for the network traffic gauger.
